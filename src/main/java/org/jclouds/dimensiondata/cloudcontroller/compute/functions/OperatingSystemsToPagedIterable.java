...
@Beta
public class OperatingSystemsToPagedIterable extends Arg0ToPagedIterable.FromCaller<Datacenter, OperatingSystemsToPagedIterable> {

    private final DimensionDataCloudControllerApi api;

    @Inject
    protected OperatingSystemsToPagedIterable(DimensionDataCloudControllerApi api) {
        this.api = checkNotNull(api, "api");
    }

    @Override
    protected Function<Object, IterableWithMarker<Datacenter>> markerToNextForArg0(Optional<Object> ignored) {
        final InfrastructureApi infrastructureApi = api.getInfrastructureApi();
        return new Function<Object, IterableWithMarker<Datacenter>>() {
            ...
            public IterableWithMarker<Datacenter> apply(Object input) {
                ...
                return IterableWithMarker.class.cast(infrastructureApi.listOperatingSystems("", paginationOptions));
            }

            @Override
            public String toString() {
                return "listOperatingSystems()";
            }
        };
    }
