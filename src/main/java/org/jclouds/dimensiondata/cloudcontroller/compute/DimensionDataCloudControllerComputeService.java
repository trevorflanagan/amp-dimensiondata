...
@Singleton
public class DimensionDataCloudControllerComputeService extends BaseComputeService {
   ...
   /**
    * returns template options, except of type {@link DimensionDataCloudControllerTemplateOptions}.
    */
   @Override
   public DimensionDataCloudControllerTemplateOptions templateOptions() {
      return DimensionDataCloudControllerTemplateOptions.class.cast(super.templateOptions());
   }
