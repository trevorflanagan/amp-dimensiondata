...
public class CreateServerOptions implements MapBinder {
   ...
   abstract static class ServerRequest {
      ...
      static ServerRequest create(String name, String imageId, Boolean start, NetworkInfo networkInfo, List<Disk> disks,
                                  String administratorPassword, String description, CPU cpu, Integer memoryGb,
                                  String primaryDns, String secondaryDns, String microsoftTimeZone) {
         return new AutoValue_CreateServerOptions_ServerRequest(name, imageId, start, networkInfo, disks, administratorPassword, description,
