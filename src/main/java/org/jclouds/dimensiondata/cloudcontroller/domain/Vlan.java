...
public abstract class Vlan {
    ...
    public static Vlan create(String id, String name, String description, String datacenterId, String state, String createTime, String ipv4GatewayAddress, String ipv6GatewayAddress, NetworkDomain networkDomain, IpRange privateIpv4Range, IpRange ipv6Range) {
        return builder().id(id).name(name).description(description).datacenterId(datacenterId).state(state).createTime(createTime).ipv4GatewayAddress(ipv4GatewayAddress).ipv6GatewayAddress(ipv6GatewayAddress).networkDomain(networkDomain).privateIpv4Range(privateIpv4Range).ipv6Range(ipv6Range).build();
    }
