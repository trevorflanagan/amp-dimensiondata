...
public class DimensionDataCloudControllerUtils {
    ...
    public static Optional<String> tryFindServerId(Response response) {
    ...
    public static boolean waitForServerStatus(ServerApi api, String serverId, boolean started, boolean deployed, long timeoutMillis) {
        return retry(new ServerStatus(api, started, deployed), timeoutMillis).apply(serverId);
    }
}
