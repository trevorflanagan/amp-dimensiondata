...
import org.jclouds.dimensiondata.cloudcontroller.domain.Tags;
...
@Singleton
public class ParseTags extends ParseJson<Tags> {

   @Inject
   public ParseTags(Json json, TypeLiteral <Tags> type) {
      super(json, type);
   }

   public static class ToPagedIterable extends ArgsToPagedIterable<Tag, ParseTags.ToPagedIterable> {
