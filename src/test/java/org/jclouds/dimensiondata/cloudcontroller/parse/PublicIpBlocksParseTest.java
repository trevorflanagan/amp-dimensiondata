...
@Test(groups = "unit")
public class PublicIpBlocksParseTest extends BaseDimensionDataCloudControllerParseTest<PublicIpBlocks> {
    ...
    public PublicIpBlocks expected() {
        List<PublicIpBlock> publicIpBlocks = ImmutableList.of(
                PublicIpBlock.builder()
